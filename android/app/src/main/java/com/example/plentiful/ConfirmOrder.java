...
public class ConfirmOrder extends AppCompatActivity {
    TextView tv_item_price,tv_del_charge,tv_order_total,tv_adrs_name,tv_adrs;
    Button btn_confirm;
    int oi_id,order_id,buyer_id,del_charge,item_price,order_total,pincode;
    String adrs_name,adrs,city,status;
